...
\begin{center}
    ...
    {\large\color{mediumgray}Senior Data Engineer}\\[4pt]
...
\begin{itemize}[leftmargin=15pt,itemsep=2pt]
    ...
    \item[\verdigrisbullet] \textbf{AI \& LLMs:} Frontier LLMs (Claude, GPT, open models), RAG systems, vector databases, agentic workflows
...
\begin{itemize}[leftmargin=15pt,itemsep=2pt]
    ...
    \item[\verdigrisbullet] \textbf{Development:} API design, backend services, open-source leadership
...
\begin{itemize}[leftmargin=15pt,itemsep=3pt]
    \item[\verdigrisbullet] Built LLM-powered pipelines processing 10M+ documents daily for Fortune 500 clients
    \item[\verdigrisbullet] Architected data infrastructure handling 1B+ log entries with sub-second query performance
    \item[\verdigrisbullet] Technical lead for a team of 6 engineers on the flagship internal product
...
\textbf{\large\color{navy}Wolfram Research South America - Research Programmer} \hfill \jobduration{2012 - 2014}\\
\companyname{Lima, Peru (Remote)}

\begin{itemize}[leftmargin=15pt,itemsep=3pt]
    \item[\verdigrisbullet] Developed data pipelines for the Wolfram$|$Alpha knowledge engine
    \item[\verdigrisbullet] Owned specific data domains end-to-end, including ingestion and quality
    \item[\verdigrisbullet] Worked in a remote, globally distributed team
\end{itemize}
